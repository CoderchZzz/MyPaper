...
new_class_names1 = ['aeroplane', 'bicycle', 'bird avian', 'boat', 'bottle',
...
new_class_names = ['aeroplane', 'bicycle', 'bird', 'boat', 'bottle',
                   'bus', 'car', 'cat', 'chair', 'cow',
...
origin_class_names_coco = ['person', 'bicycle', 'car', 'motorcycle', 'airplane', 'bus', 'train', 'truck', 'boat', 'traffic light',
...
new_class_names_coco = ['person with clothes,people,human','bicycle','car','motorcycle','airplane',
                    'bus','train','truck','boat','traffic light',
