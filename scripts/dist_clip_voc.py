...
parser.add_argument("--vqa_bg_file", type=str, default="voc_vqa1/voc_vqa_bg_blip.npy")
parser.add_argument("--vqa_fg_file", type=str, default="voc_vqa1/voc_vqa_fg_blip.npy")
parser.add_argument("--vqa_bg_cache_file", type=str, default="voc_vqa1/voc_vqa_bg_blip_ViT-B-16_cache.npy")
parser.add_argument("--vqa_fg_cache_file", type=str, default="voc_vqa1/voc_vqa_fg_blip_ViT-B-16_cache.npy")
parser.add_argument("--clip_name", type=str, default="ViT-B/16")
parser.add_argument("--use_mask_clip", type=str2bool, default=False)
...
def train(cfg):
    ...
    cam_args = Namespace(
        clip=args.clip_name,
        use_mask_clip=args.use_mask_clip,
        vqa_bg_file=args.vqa_bg_file,
        vqa_fg_file=args.vqa_fg_file,
        vqa_bg_cache_file=args.vqa_bg_cache_file,
        vqa_fg_cache_file=args.vqa_fg_cache_file,
    )
    ...
    for n_iter in range(cfg.train.max_iters):
        ...
        logging.info("Iter : %d finished;  "%(n_iter+1))
        pseudo_label = cam
