...
parser.add_argument("--config",
                    default='configs/voc_attn_test.yaml',
                    type=str,
                    help="config")
parser.add_argument("--work_dir", default="results/2025-11-28", type=str, help="work_dir")
...
parser.add_argument("--model_path", default="scripts/work_dir_voc/checkpoints/2025-11-27-15-54/WeCLIP_model_iter_30000.pth", type=str, help="model_path")
